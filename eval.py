...
if __name__ == '__main__': 
	model_name = '/media/Data/wt/pytorch_dl_framework/out/model_epoch_15.pth'
	test_img_path = os.path.abspath('/media/Data/hzc/datasets/ocr/refine_text_detection_data/images/')
	submit_path = './submit'
